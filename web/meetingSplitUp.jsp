<%-- 
    Document   : meetingSplitUp
    Created on : Apr 6, 2019, 7:26:55 PM
    Author     : Sathish
--%>
...
<html lang="en">
  ...
  <title>Meeting Split Up Page</title>
  <!-- Font Awesome -->
                ...
                <div class="row">
                    <div class="col col-sm-4 col-lg-4 col-md-4">
                        ...
                        <div class="card">
                          ...
                          <div class="view overlay">
                            <img class="card-img-top" src="Assets/images/mail.png" alt="mail images">
                            <a href="#!">
                          ...
                          <div class="card-body">
                            ...
                            <!-- Title -->
                            <h4 class="card-title">Sending Mail</h4>
                            <!-- Text -->
                            <p class="card-text">Click the below button to sent mail to committee members</p>
                            <!-- Button -->
                            <a href="mailSending.jsp" class="btn btn-primary">Click Here</a>
                    ...
                    <div class="col col-sm-4 col-lg-4 col-md-4">
                        ...
                        <div class="card">
                          ...
                          <!-- Card image -->
                          <div class="view overlay">
                            <img class="card-img-top" src="Assets/images/chat.png" alt="chatimages" style="height:350px;">
                            <a href="#!">
                              <div class="mask rgba-white-slight"></div>
                            </a>
                          </div>
                          ...
                          <div class="card-body">
                            ...
                            <!-- Title -->
                            <h4 class="card-title">Chat Forum</h4>
                            <!-- Text -->
                            <p class="card-text">Click the below button to go chat forem</p>
                            <!-- Button -->
                            <a href="chatForum.jsp" class="btn btn-primary">Click Here</a>
