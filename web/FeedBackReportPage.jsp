<%-- 
    Document   : FeedBackReportPage
    Created on : Apr 8, 2019, 12:00:47 AM
    Author     : Sathish
--%>
  ...
  <link rel="shortcut icon" href="img/sourceImg/ksricon.png" type="image/x-icon">
    ...
    <body> 
        ...
        <div class="container" id="el">
            ...
            <center class="mt-4"><h2 style="color:blue;font-weight: 500;">Feedback Report</h2></center>
...
//            Converting pdf
            ...
            function getData() {
                ...
                request.open("POST", "./OriginalFeedBack?message="+from,true);
                request.send();
            }
            ...
            for(var i=0;i<displayMessage.length;i=i+4){
                  ...
                  chatResult += "<li style='font-size:20px;'>" + displayMessage[i]+" :"+displayMessage[i+1]+"<br><small>"+displayMessage[i+2]+" "+displayMessage[i+3]+"</small></li>";
                  dispalay_button();
